...
\begin{itemize}
  \item Explain the central problem addressed by Metaprogramming and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Metaprogramming; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Metaprogramming generates or selects code at translation time. It can remove duplication and enforce invariants, but generated complexity must remain explainable to maintainers.
...
The complete standalone program for this chapter is stored at examples/chapters/ch174.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch174.cpp}
