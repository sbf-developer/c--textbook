\chapter{Stacks, Queues, and Priority Queues}
\index{Stacks, Queues, and Priority Queues}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Stacks, Queues, and Priority Queues and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Stacks, Queues, and Priority Queues; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Adaptors expose restricted interfaces for disciplined access patterns. Restricting operations can make invariants and intent clearer.
...
The complete standalone program for this chapter is stored at examples/chapters/ch073.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch073.cpp}
