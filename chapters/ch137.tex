...
\begin{itemize}
  \item Explain the central problem addressed by Continuous Integration and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Continuous Integration; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Continuous integration builds and tests changes in a clean, repeatable environment. It is a feedback system, not a substitute for design or local verification.
...
The complete standalone program for this chapter is stored at examples/chapters/ch137.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch137.cpp}
