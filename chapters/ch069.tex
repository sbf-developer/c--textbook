...
\begin{itemize}
  \item Explain the central problem addressed by Function Objects and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Function Objects; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Callable objects include functions, pointers to functions, lambdas, and types with operator(). They let algorithms receive behavior without committing to one global name.
...
The complete standalone program for this chapter is stored at examples/chapters/ch069.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch069.cpp}
