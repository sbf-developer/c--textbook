...
\begin{itemize}
  \item Explain the central problem addressed by Atomic Operations and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Atomic Operations; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Atomics provide indivisible operations and synchronization orders for selected objects. They do not make a multi-object invariant automatically safe.
...
The complete standalone program for this chapter is stored at examples/chapters/ch149.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch149.cpp}
