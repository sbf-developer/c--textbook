\chapter{Reading Compiler Diagnostics}
\index{Reading Compiler Diagnostics}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Reading Compiler Diagnostics and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Reading Compiler Diagnostics; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Diagnostics are evidence about a failed translation, not personal judgement. The chapter teaches readers to locate the first useful message, reduce the problem, and distinguish syntax, type, and linker failures.
...
The complete standalone program for this chapter is stored at examples/chapters/ch008.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch008.cpp}
