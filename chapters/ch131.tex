...
\index{Version Control with Git}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Version Control with Git and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Version Control with Git; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Version control records changes as reviewable history. Small commits, meaningful messages, and reproducible branches reduce the cost of collaboration and recovery.
...
The complete standalone program for this chapter is stored at examples/chapters/ch131.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch131.cpp}
