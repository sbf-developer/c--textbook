\chapter{Integers, Floating-Point Values, and Precision}
\index{Integers, Floating-Point Values, and Precision}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Integers, Floating-Point Values, and Precision and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Integers, Floating-Point Values, and Precision; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Integer arithmetic and floating-point arithmetic have different error models. Range, rounding, comparison, and conversion choices should follow the problem rather than intuition from decimal notation.
...
The complete standalone program for this chapter is stored at examples/chapters/ch028.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch028.cpp}
