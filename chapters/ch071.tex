...
\begin{itemize}
  \item Explain the central problem addressed by Associative Containers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Associative Containers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Ordered maps and sets use keys and ordering to provide logarithmic operations under their specified complexity model. Key comparability and iterator stability shape their use.
...
The complete standalone program for this chapter is stored at examples/chapters/ch071.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch071.cpp}
