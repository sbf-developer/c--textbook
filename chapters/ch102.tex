...
\begin{itemize}
  \item Explain the central problem addressed by Sanitizers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Sanitizers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Address, undefined-behavior, and thread sanitizers instrument programs to catch classes of defects. They increase cost and coverage needs but often turn mysterious symptoms into local failures.
...
The complete standalone program for this chapter is stored at examples/chapters/ch102.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch102.cpp}
