...
\begin{itemize}
  \item Explain the central problem addressed by Composition and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Composition; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Composition builds a type from collaborating parts. It usually makes dependencies and replacement boundaries clearer than a deep inheritance hierarchy.
...
The complete standalone program for this chapter is stored at examples/chapters/ch056.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch056.cpp}
