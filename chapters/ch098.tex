...
\begin{itemize}
  \item Explain the central problem addressed by Integration Testing and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Integration Testing; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Integration tests exercise boundaries among real components. They catch configuration, serialization, file, and lifecycle defects that unit tests intentionally exclude.
...
The complete standalone program for this chapter is stored at examples/chapters/ch098.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch098.cpp}
