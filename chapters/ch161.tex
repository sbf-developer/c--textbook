...
\begin{itemize}
  \item Explain the central problem addressed by Compiler Optimization and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Compiler Optimization; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Optimization flags change generated code under the language rules. They do not repair undefined behavior or make an invalid program valid.
...
The complete standalone program for this chapter is stored at examples/chapters/ch161.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch161.cpp}
