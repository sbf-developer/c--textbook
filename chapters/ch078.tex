...
\begin{itemize}
  \item Explain the central problem addressed by File Input and Output and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: File Input and Output; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
File streams connect C++ objects to persistent bytes. Correct file handling checks open and operation states, specifies encoding and format, and separates parsing from storage policy.
...
The complete standalone program for this chapter is stored at examples/chapters/ch078.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch078.cpp}
