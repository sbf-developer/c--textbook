...
\begin{itemize}
  \item Explain the central problem addressed by Portability and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Portability; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Portable code depends on specified behavior and isolates platform assumptions. Portability is a property of an interface and build process, not just of source syntax.
...
The complete standalone program for this chapter is stored at examples/chapters/ch138.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch138.cpp}
