...
\index{Classes and Objects}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Classes and Objects and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Classes and Objects; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A class defines a type; an object is an instance with state and lifetime. A good type makes valid states easy to construct and invalid states difficult to represent.
...
The complete standalone program for this chapter is stored at examples/chapters/ch047.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch047.cpp}
