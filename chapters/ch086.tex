...
\begin{itemize}
  \item Explain the central problem addressed by Compile-Time Programming and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Compile-Time Programming; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Compile-time programming moves selected work into translation. The benefit is an earlier check or a generated specialization, not a blanket claim that compile-time code is always faster.
...
The complete standalone program for this chapter is stored at examples/chapters/ch086.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch086.cpp}
