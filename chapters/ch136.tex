...
\begin{itemize}
  \item Explain the central problem addressed by Code Review and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Code Review; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Code review is a second line of reasoning about correctness, risk, and maintainability. Review comments should identify evidence and consequences rather than preferences alone.
...
The complete standalone program for this chapter is stored at examples/chapters/ch136.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch136.cpp}
