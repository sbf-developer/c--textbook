\chapter{Copy and Move Semantics}
\index{Copy and Move Semantics}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Copy and Move Semantics and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Copy and Move Semantics; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Copying duplicates a value or resource representation; moving transfers or cheaply reuses resources. A type's special members should preserve its invariants and ownership rules.
...
The complete standalone program for this chapter is stored at examples/chapters/ch043.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch043.cpp}
