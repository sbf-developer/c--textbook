...
\begin{itemize}
  \item Explain the central problem addressed by Multiple Inheritance and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Multiple Inheritance; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Multiple inheritance can model independent interfaces or shared implementation, but ambiguity and layout complexity increase. It is most defensible when each base has a clear role.
...
The complete standalone program for this chapter is stored at examples/chapters/ch062.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch062.cpp}
