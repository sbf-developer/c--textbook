\chapter{Thread-Safe Design}
\index{Thread-Safe Design}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Thread-Safe Design and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Thread-Safe Design; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Thread safety is a property of an interface under concurrent use. Immutable values, ownership transfer, message passing, and narrow synchronized boundaries often outperform shared mutable state as a design strategy.
...
The complete standalone program for this chapter is stored at examples/chapters/ch152.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch152.cpp}
