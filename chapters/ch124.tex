\chapter{One Definition Rule}
\index{One Definition Rule}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by One Definition Rule and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: One Definition Rule; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
The One Definition Rule constrains which entities may have one or multiple definitions across a program. Violations can compile and still produce ill-formed or fragile binaries.
...
The complete standalone program for this chapter is stored at examples/chapters/ch124.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch124.cpp}
