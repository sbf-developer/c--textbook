\chapter{Organizing Source and Header Files}
\index{Organizing Source and Header Files}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Organizing Source and Header Files and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Organizing Source and Header Files; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Headers expose declarations and reusable definitions; source files hold implementation details. Organization should express ownership and minimize unnecessary recompilation.
...
The complete standalone program for this chapter is stored at examples/chapters/ch123.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch123.cpp}
