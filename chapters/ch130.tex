...
\index{Package Managers}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Package Managers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Package Managers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Package managers resolve and build external libraries. Locking versions and documenting triplets, toolchains, and feature choices keeps builds reproducible.
...
The complete standalone program for this chapter is stored at examples/chapters/ch130.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch130.cpp}
