\chapter{Overloading and Default Arguments}
\index{Overloading and Default Arguments}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Overloading and Default Arguments and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Overloading and Default Arguments; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Overloading lets one name denote several signatures, while default arguments fill omitted values. Both features can improve interfaces but can also create ambiguity and surprising calls.
...
The complete standalone program for this chapter is stored at examples/chapters/ch022.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch022.cpp}
