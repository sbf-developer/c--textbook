...
\begin{itemize}
  \item Explain the central problem addressed by Pointers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Pointers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A pointer is an object that can hold an address or a null value. It can represent optional access or navigation; it becomes ownership only through an explicit protocol.
...
The complete standalone program for this chapter is stored at examples/chapters/ch035.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch035.cpp}
