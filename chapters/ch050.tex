...
\begin{itemize}
  \item Explain the central problem addressed by Destructors and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Destructors; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Destruction releases owned resources and ends an object's lifetime. Destructors should be reliable, bounded in responsibility, and normally non-throwing.
...
The complete standalone program for this chapter is stored at examples/chapters/ch050.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch050.cpp}
