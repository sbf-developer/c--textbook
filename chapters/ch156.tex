\chapter{Profiling Before Optimization}
\index{Profiling Before Optimization}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Profiling Before Optimization and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Profiling Before Optimization; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Profiling locates observed cost in a workload. It prevents optimizing code that is elegant or suspicious but irrelevant to the actual bottleneck.
...
The complete standalone program for this chapter is stored at examples/chapters/ch156.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch156.cpp}
