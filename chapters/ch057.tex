...
\begin{itemize}
  \item Explain the central problem addressed by Inheritance and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Inheritance; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Inheritance expresses a relationship between a derived type and a base interface or implementation. Public inheritance is a substitutability claim, not merely code reuse.
...
The complete standalone program for this chapter is stored at examples/chapters/ch057.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch057.cpp}
