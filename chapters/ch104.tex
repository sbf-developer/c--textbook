...
\begin{itemize}
  \item Explain the central problem addressed by Logging and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Logging; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Logs record selected events and context for diagnosis. Levels, stable fields, privacy, volume, and correlation identifiers determine whether logs are useful in production.
...
The complete standalone program for this chapter is stored at examples/chapters/ch104.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch104.cpp}
