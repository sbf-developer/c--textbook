\chapter{Characters, Text, Encoding, and Unicode}
\index{Characters, Text, Encoding, and Unicode}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Characters, Text, Encoding, and Unicode and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Characters, Text, Encoding, and Unicode; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A character, a code point, a code unit, and a user-perceived grapheme are distinct ideas. std::string stores bytes; text correctness requires an explicit encoding policy.
...
The complete standalone program for this chapter is stored at examples/chapters/ch029.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch029.cpp}
