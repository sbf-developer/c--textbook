\chapter{The C++ Memory Model}
\index{The C++ Memory Model}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by The C++ Memory Model and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: The C++ Memory Model; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
The memory model describes visibility, ordering, happens-before, and data races. It explains why compiler and processor reordering can matter even when source statements look sequential.
...
The complete standalone program for this chapter is stored at examples/chapters/ch150.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch150.cpp}
