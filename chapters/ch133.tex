...
\begin{itemize}
  \item Explain the central problem addressed by API Design and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: API Design; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
An API is a promise about names, types, ownership, failure, timing, and compatibility. Good APIs make common correct use easy and unsupported use visible.
...
The complete standalone program for this chapter is stored at examples/chapters/ch133.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch133.cpp}
