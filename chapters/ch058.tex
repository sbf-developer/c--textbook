\chapter{Runtime Polymorphism}
\index{Runtime Polymorphism}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Runtime Polymorphism and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Runtime Polymorphism; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Runtime polymorphism selects an operation through a dynamic type. It is useful when the set of concrete types varies at runtime and a stable interface matters.
...
The complete standalone program for this chapter is stored at examples/chapters/ch058.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch058.cpp}
