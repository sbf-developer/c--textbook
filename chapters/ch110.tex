...
\begin{itemize}
  \item Explain the central problem addressed by Recursion and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Recursion; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Recursion solves a problem through smaller instances and a base case. Correctness requires progress toward the base case; performance requires understanding call depth and repeated work.
...
The complete standalone program for this chapter is stored at examples/chapters/ch110.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch110.cpp}
