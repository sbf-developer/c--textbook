...
\begin{itemize}
  \item Explain the central problem addressed by Arrays and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Arrays; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Built-in arrays provide contiguous elements and fixed extent, but decay and bounds mistakes make interfaces fragile. The chapter explains what the type really is before introducing safer views.
...
The complete standalone program for this chapter is stored at examples/chapters/ch030.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch030.cpp}
