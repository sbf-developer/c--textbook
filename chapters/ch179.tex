...
\begin{itemize}
  \item Explain the central problem addressed by Domain Modeling and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Domain Modeling; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Domain modeling gives important concepts explicit names, invariants, and operations. A useful model reflects decisions and constraints rather than mirroring every database column.
...
The complete standalone program for this chapter is stored at examples/chapters/ch179.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch179.cpp}
