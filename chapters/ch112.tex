...
\begin{itemize}
  \item Explain the central problem addressed by Sorting and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Sorting; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Sorting establishes an ordering that can simplify later work. Stability, memory use, comparator correctness, and complexity all matter beyond the name of an algorithm.
...
The complete standalone program for this chapter is stored at examples/chapters/ch112.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch112.cpp}
