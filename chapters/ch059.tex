\chapter{Abstract Interfaces}
\index{Abstract Interfaces}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Abstract Interfaces and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Abstract Interfaces; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
An abstract interface states capabilities without choosing a representation. Small interfaces reduce accidental coupling and make test doubles more practical.
...
The complete standalone program for this chapter is stored at examples/chapters/ch059.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch059.cpp}
