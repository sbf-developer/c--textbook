\chapter{Writing, Compiling, and Running the First Program}
\index{Writing, Compiling, and Running the First Program}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Writing, Compiling, and Running the First Program and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Writing, Compiling, and Running the First Program; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
The first program makes the translation pipeline visible: create a source file, invoke the compiler, inspect the executable, run it, and observe standard output and the exit status.
...
The complete standalone program for this chapter is stored at examples/chapters/ch007.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch007.cpp}
