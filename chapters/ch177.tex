...
\begin{itemize}
  \item Explain the central problem addressed by Architectural Patterns and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Architectural Patterns; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Architecture allocates responsibilities and dependencies across a system. Patterns are vocabulary for recurring trade-offs, not templates that remove the need for domain reasoning.
...
The complete standalone program for this chapter is stored at examples/chapters/ch177.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch177.cpp}
