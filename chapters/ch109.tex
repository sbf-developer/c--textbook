...
\begin{itemize}
  \item Explain the central problem addressed by Asymptotic Complexity and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Asymptotic Complexity; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Asymptotic notation describes how resource use grows as input size grows. It abstracts constants and hardware, which is useful for scaling questions but insufficient for every engineering choice.
...
The complete standalone program for this chapter is stored at examples/chapters/ch109.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch109.cpp}
