...
\begin{itemize}
  \item Explain the central problem addressed by Smart Pointers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Smart Pointers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
unique\_ptr expresses exclusive ownership, shared\_ptr expresses shared ownership, and weak\_ptr observes shared ownership without keeping it alive. The choice is a design statement, not a performance superstition.
...
The complete standalone program for this chapter is stored at examples/chapters/ch041.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch041.cpp}
