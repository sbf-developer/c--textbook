\chapter{Optional Values and Variants}
\index{Optional Values and Variants}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Optional Values and Variants and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Optional Values and Variants; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
optional represents a value that may be absent; variant represents one active alternative from a closed set. Both make state explicit without sentinel values.
...
The complete standalone program for this chapter is stored at examples/chapters/ch074.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch074.cpp}
