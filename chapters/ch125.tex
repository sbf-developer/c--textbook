...
\begin{itemize}
  \item Explain the central problem addressed by Separate Compilation and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Separate Compilation; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Separate compilation turns translation units into independently compiled objects. Stable interfaces and dependency boundaries make large builds faster and easier to reason about.
...
The complete standalone program for this chapter is stored at examples/chapters/ch125.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch125.cpp}
