...
\begin{itemize}
  \item Explain the central problem addressed by Hash Tables and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Hash Tables; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Hash tables map keys to buckets using a hash function. Correct equality and hash consistency are mandatory; collisions and load determine observed performance.
...
The complete standalone program for this chapter is stored at examples/chapters/ch117.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch117.cpp}
