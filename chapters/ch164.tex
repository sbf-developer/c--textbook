...
\index{Performance Portability}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Performance Portability and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Performance Portability; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
An optimization that helps one compiler or processor can harm another. Portable performance comes from a clear model, measurement on target environments, and modest assumptions.
...
The complete standalone program for this chapter is stored at examples/chapters/ch164.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch164.cpp}
