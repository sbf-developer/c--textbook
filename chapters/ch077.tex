\chapter{Random-Number Facilities}
\index{Random-Number Facilities}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Random-Number Facilities and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Random-Number Facilities; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Random engines generate deterministic sequences from state; distributions map those sequences to a desired statistical shape. Reproducibility, seeding, and security requirements must be separated.
...
The complete standalone program for this chapter is stored at examples/chapters/ch077.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch077.cpp}
