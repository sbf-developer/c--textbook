\chapter{Reproducing and Minimizing Bugs}
\index{Reproducing and Minimizing Bugs}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Reproducing and Minimizing Bugs and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Reproducing and Minimizing Bugs; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A reproducible failure is a scientific foothold. Reduce inputs, environment, and timing until the smallest case still demonstrates the defect.
...
The complete standalone program for this chapter is stored at examples/chapters/ch105.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch105.cpp}
