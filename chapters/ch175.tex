...
\begin{itemize}
  \item Explain the central problem addressed by Type Erasure and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Type Erasure; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Type erasure stores values behind a uniform interface while hiding their concrete type. It trades some compile-time visibility for runtime flexibility and stable boundaries.
...
The complete standalone program for this chapter is stored at examples/chapters/ch175.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch175.cpp}
