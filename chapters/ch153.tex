...
\begin{itemize}
  \item Explain the central problem addressed by Parallel Algorithms and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Parallel Algorithms; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Parallel algorithms divide work under a policy, but speedup depends on independence, granularity, scheduling, memory bandwidth, and overhead.
...
The complete standalone program for this chapter is stored at examples/chapters/ch153.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch153.cpp}
