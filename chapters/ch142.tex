...
\index{Interoperability with Other Languages}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Interoperability with Other Languages and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Interoperability with Other Languages; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Language interoperability is an interface-design problem involving data representation, calling conventions, ownership, errors, and packaging. A narrow C ABI is often a useful stable boundary.
...
The complete standalone program for this chapter is stored at examples/chapters/ch142.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch142.cpp}
