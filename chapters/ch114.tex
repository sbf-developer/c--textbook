...
\index{Stacks and Queues}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Stacks and Queues and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Stacks and Queues; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Stacks and queues restrict access to express last-in-first-out or first-in-first-out policy. The abstraction often matters more than the underlying container.
...
The complete standalone program for this chapter is stored at examples/chapters/ch114.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch114.cpp}
