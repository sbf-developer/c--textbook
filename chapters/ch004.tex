\chapter{Compilers, Linkers, Libraries, and Build Processes}
\index{Compilers, Linkers, Libraries, and Build Processes}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Compilers, Linkers, Libraries, and Build Processes and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Compilers, Linkers, Libraries, and Build Processes; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A compiler checks and translates a translation unit; a linker resolves references among object files and libraries. Build systems make those steps repeatable and avoid needless work.
...
The complete standalone program for this chapter is stored at examples/chapters/ch004.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch004.cpp}
