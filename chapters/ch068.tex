\chapter{Ranges and Views}
\index{Ranges and Views}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Ranges and Views and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Ranges and Views; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Ranges compose algorithms and views with less iterator plumbing. Views are usually lazy and non-owning, so lifetime and repeated evaluation remain design concerns.
...
The complete standalone program for this chapter is stored at examples/chapters/ch068.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch068.cpp}
