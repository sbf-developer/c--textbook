...
\index{Design Patterns in Modern C++}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Design Patterns in Modern C++ and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Design Patterns in Modern C++; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Modern C++ changes the cost and shape of classic patterns through value semantics, lambdas, concepts, smart pointers, and standard components. Use the simplest mechanism that expresses the intent.
...
The complete standalone program for this chapter is stored at examples/chapters/ch178.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch178.cpp}
