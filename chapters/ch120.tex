...
\begin{itemize}
  \item Explain the central problem addressed by Greedy Algorithms and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Greedy Algorithms; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Greedy algorithms commit to a locally attractive choice. They are correct only when a proof or established property connects local choices to a global optimum.
...
The complete standalone program for this chapter is stored at examples/chapters/ch120.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch120.cpp}
