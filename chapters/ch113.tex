...
\begin{itemize}
  \item Explain the central problem addressed by Linked Structures and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Linked Structures; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Linked structures connect nodes through references or pointers. They teach ownership and invalidation, but their pointer flexibility can trade away locality and simplicity.
...
The complete standalone program for this chapter is stored at examples/chapters/ch113.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch113.cpp}
