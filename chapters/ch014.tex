\chapter{Arithmetic and Operators}
\index{Arithmetic and Operators}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Arithmetic and Operators and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Arithmetic and Operators; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Operators are syntax with specified operands, result types, sequencing, and possible conversions. Arithmetic becomes safer when ranges, overflow, and integer division are made explicit.
...
The complete standalone program for this chapter is stored at examples/chapters/ch014.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch014.cpp}
