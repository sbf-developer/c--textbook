...
\begin{itemize}
  \item Explain the central problem addressed by Property-Based Testing and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Property-Based Testing; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Property-based testing generates many inputs to check general relationships. The property must be a real invariant, not a restatement of the implementation.
...
The complete standalone program for this chapter is stored at examples/chapters/ch099.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch099.cpp}
