...
\begin{itemize}
  \item Explain the central problem addressed by CMake and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: CMake; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
CMake describes targets, properties, dependencies, tests, and installation rather than hard-coding one platform's commands. Generators then produce a native build system.
...
The complete standalone program for this chapter is stored at examples/chapters/ch128.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch128.cpp}
