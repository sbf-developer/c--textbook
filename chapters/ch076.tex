\chapter{Time and Clocks}
\index{Time and Clocks}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Time and Clocks and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Time and Clocks; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A duration is an amount of time; a time point is a position on a clock. Steady clocks are appropriate for elapsed-time measurement; wall clocks can jump.
...
The complete standalone program for this chapter is stored at examples/chapters/ch076.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch076.cpp}
