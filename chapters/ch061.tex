...
\index{Object Slicing}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Object Slicing and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Object Slicing; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Copying a derived object into a base value discards the derived part. References, pointers, and value-oriented alternatives avoid slicing when polymorphism is intended.
...
The complete standalone program for this chapter is stored at examples/chapters/ch061.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch061.cpp}
