...
\begin{itemize}
  \item Explain the central problem addressed by Dynamic Programming and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Dynamic Programming; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Dynamic programming stores solutions to overlapping subproblems. A recurrence, state definition, base case, and evaluation order make the optimization auditable.
...
The complete standalone program for this chapter is stored at examples/chapters/ch119.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch119.cpp}
