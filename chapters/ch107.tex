...
\begin{itemize}
  \item Explain the central problem addressed by Algorithmic Thinking and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Algorithmic Thinking; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Algorithmic thinking names state, operations, invariants, termination, and cost before code. It turns a vague task into a sequence that can be reviewed and tested.
...
The complete standalone program for this chapter is stored at examples/chapters/ch107.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch107.cpp}
