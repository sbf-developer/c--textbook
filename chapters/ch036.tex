\chapter{Null Pointers}
\index{Null Pointers}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Null Pointers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Null Pointers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A null pointer represents no pointed-to object. Comparing, testing, and avoiding dereference are simple rules, but nullable interfaces should be used only when absence is meaningful.
...
The complete standalone program for this chapter is stored at examples/chapters/ch036.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch036.cpp}
