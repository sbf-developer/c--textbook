\chapter{Legacy-Code Modernization}
\index{Legacy-Code Modernization}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Legacy-Code Modernization and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Legacy-Code Modernization; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Modernization reduces risk while preserving necessary behavior. Characterization tests, seams, staged replacement, and explicit deprecation are more reliable than a wholesale rewrite by optimism.
...
The complete standalone program for this chapter is stored at examples/chapters/ch182.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch182.cpp}
