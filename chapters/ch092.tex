...
\begin{itemize}
  \item Explain the central problem addressed by Assertions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Assertions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Assertions state conditions expected to be true when a defect would indicate a programming error. They complement, rather than replace, handling of ordinary external failures.
...
The complete standalone program for this chapter is stored at examples/chapters/ch092.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch092.cpp}
