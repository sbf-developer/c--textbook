...
\begin{itemize}
  \item Explain the central problem addressed by Constructors and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Constructors; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Constructors establish initial invariants. Member-initializer lists, delegating constructors, and explicit conversions make construction predictable and resistant to partial initialization.
...
The complete standalone program for this chapter is stored at examples/chapters/ch049.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch049.cpp}
