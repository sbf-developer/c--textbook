\chapter{Variables and Initialization}
\index{Variables and Initialization}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Variables and Initialization and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Variables and Initialization; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A variable gives an object a name and a type. Initialization creates its initial state, while assignment changes an already existing object; confusing the two causes subtle bugs.
...
The complete standalone program for this chapter is stored at examples/chapters/ch011.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch011.cpp}
