...
\begin{itemize}
  \item Explain the central problem addressed by Object Lifetime and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Object Lifetime; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
An object has a lifetime with a beginning and an end. Using storage outside that lifetime, or with the wrong type, is a correctness error even if the bytes look unchanged.
...
The complete standalone program for this chapter is stored at examples/chapters/ch039.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch039.cpp}
