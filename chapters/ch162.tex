...
\begin{itemize}
  \item Explain the central problem addressed by Benchmark Design and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Benchmark Design; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A benchmark needs representative inputs, warm-up policy, measurement boundaries, repetition, and a way to avoid measuring dead-code elimination or setup accidentally.
...
The complete standalone program for this chapter is stored at examples/chapters/ch162.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch162.cpp}
