\chapter{Variadic Templates}
\index{Variadic Templates}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Variadic Templates and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Variadic Templates; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Parameter packs represent an arbitrary number of arguments or types. Fold expressions make common reductions concise, while recursive designs remain useful for some structural problems.
...
The complete standalone program for this chapter is stored at examples/chapters/ch085.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch085.cpp}
