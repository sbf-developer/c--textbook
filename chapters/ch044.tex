\chapter{Value Categories}
\index{Value Categories}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Value Categories and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Value Categories; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Expressions have categories that affect binding, overload resolution, and moving. The useful beginner model is lvalue as an identifiable object and rvalue as a temporary or expiring value; the formal model is more precise.
...
The complete standalone program for this chapter is stored at examples/chapters/ch044.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch044.cpp}
