...
\begin{itemize}
  \item Explain the central problem addressed by Function Templates and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Function Templates; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A function template describes a family of functions parameterized by types or values. Instantiation produces a concrete specialization checked for the actual arguments.
...
The complete standalone program for this chapter is stored at examples/chapters/ch081.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch081.cpp}
