...
\begin{itemize}
  \item Explain the central problem addressed by Refactoring and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Refactoring; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Refactoring changes structure while preserving externally observable behavior. Tests and small steps provide evidence that the intended behavior survived.
...
The complete standalone program for this chapter is stored at examples/chapters/ch135.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch135.cpp}
