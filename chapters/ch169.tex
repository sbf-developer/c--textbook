\chapter{Perfect Forwarding}
\index{Perfect Forwarding}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Perfect Forwarding and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Perfect Forwarding; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Perfect forwarding preserves value category and cv-qualification across a generic boundary. It is powerful for wrappers and factories but can make overload behavior harder to read.
...
The complete standalone program for this chapter is stored at examples/chapters/ch169.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch169.cpp}
