\chapter{Advanced Type-System Concepts}
\index{Advanced Type-System Concepts}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Advanced Type-System Concepts and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Advanced Type-System Concepts; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Types can encode ownership, alternatives, constraints, units, and state transitions. Strong types are valuable when their invariants justify the additional vocabulary.
...
The complete standalone program for this chapter is stored at examples/chapters/ch168.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch168.cpp}
