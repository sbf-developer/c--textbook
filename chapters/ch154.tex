\chapter{Task-Based Concurrency}
\index{Task-Based Concurrency}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Task-Based Concurrency and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Task-Based Concurrency; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Task-based designs express units of work and dependencies rather than manually managing every thread. They improve composition when the scheduler and cancellation model are understood.
...
The complete standalone program for this chapter is stored at examples/chapters/ch154.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch154.cpp}
