...
\begin{itemize}
  \item Explain the central problem addressed by Iterators and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Iterators; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Iterators generalize traversal across containers and ranges. Their validity and category determine which algorithms are legal and what complexity they can achieve.
...
The complete standalone program for this chapter is stored at examples/chapters/ch066.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch066.cpp}
