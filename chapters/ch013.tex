...
\begin{itemize}
  \item Explain the central problem addressed by Literals and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Literals; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Literals are source-level notation for values: numeric, character, string, boolean, and null-pointer literals. Suffixes and prefixes can change type and meaning.
...
The complete standalone program for this chapter is stored at examples/chapters/ch013.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch013.cpp}
