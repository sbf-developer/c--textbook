...
\begin{itemize}
  \item Explain the central problem addressed by Enumerations and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Enumerations; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Enumerations represent a closed set of named values. Scoped enumerations make conversions and ownership of names more explicit than unscoped alternatives.
...
The complete standalone program for this chapter is stored at examples/chapters/ch025.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch025.cpp}
