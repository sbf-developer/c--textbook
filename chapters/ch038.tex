\chapter{Stack and Free-Store Concepts}
\index{Stack and Free-Store Concepts}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Stack and Free-Store Concepts and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Stack and Free-Store Concepts; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Stack and free-store are useful implementation-level terms, not universal standard categories. The language specifies storage duration and lifetime; implementations choose how those are realized.
...
The complete standalone program for this chapter is stored at examples/chapters/ch038.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch038.cpp}
