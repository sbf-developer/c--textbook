...
\begin{itemize}
  \item Explain the central problem addressed by Processes and Threads and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Processes and Threads; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Processes isolate address spaces and resources; threads share an address space within a process. The distinction changes failure, communication, and synchronization costs.
...
The complete standalone program for this chapter is stored at examples/chapters/ch143.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch143.cpp}
