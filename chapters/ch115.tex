...
\begin{itemize}
  \item Explain the central problem addressed by Trees and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Trees; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Trees represent hierarchical relationships with acyclic parent-child structure. Balance, ordering, ownership, and traversal determine whether a tree solves the actual problem.
...
The complete standalone program for this chapter is stored at examples/chapters/ch115.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch115.cpp}
