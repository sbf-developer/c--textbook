...
\index{Data-Oriented Design}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Data-Oriented Design and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Data-Oriented Design; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Data-oriented design chooses representation and iteration around access patterns. It complements object-oriented boundaries when data movement dominates runtime cost.
...
The complete standalone program for this chapter is stored at examples/chapters/ch159.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch159.cpp}
