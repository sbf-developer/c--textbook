\chapter{Comparisons and Boolean Logic}
\index{Comparisons and Boolean Logic}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Comparisons and Boolean Logic and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Comparisons and Boolean Logic; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Conditions combine comparisons and logical operators. Short-circuit evaluation is useful, but only when readers understand which operands are evaluated and when.
...
The complete standalone program for this chapter is stored at examples/chapters/ch015.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch015.cpp}
