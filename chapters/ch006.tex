\chapter{Terminals, Editors, IDEs, and File Systems}
\index{Terminals, Editors, IDEs, and File Systems}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Terminals, Editors, IDEs, and File Systems and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Terminals, Editors, IDEs, and File Systems; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
The terminal is a text interface to processes, not a programming language. Editors and IDEs add navigation and diagnostics, while the file system gives source files durable names and locations.
...
The complete standalone program for this chapter is stored at examples/chapters/ch006.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch006.cpp}
