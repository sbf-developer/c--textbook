...
\begin{itemize}
  \item Explain the central problem addressed by Binary Representation and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Binary Representation; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Bits are a model for representing information, not a license to assume a particular machine layout. The chapter introduces bases, bytes, object representations, and the limits of representation-based reasoning.
...
The complete standalone program for this chapter is stored at examples/chapters/ch027.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch027.cpp}
