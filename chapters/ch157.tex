\chapter{CPU, Cache, and Memory Locality}
\index{CPU, Cache, and Memory Locality}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by CPU, Cache, and Memory Locality and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: CPU, Cache, and Memory Locality; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Modern processors move data through a hierarchy. Locality is a useful model for why access patterns matter, but exact timings are architecture and workload dependent.
...
The complete standalone program for this chapter is stored at examples/chapters/ch157.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch157.cpp}
