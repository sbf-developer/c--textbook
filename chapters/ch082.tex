...
\begin{itemize}
  \item Explain the central problem addressed by Class Templates and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Class Templates; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A class template describes a family of related types. Its parameters can encode element types, policies, allocators, or compile-time dimensions.
...
The complete standalone program for this chapter is stored at examples/chapters/ch082.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch082.cpp}
