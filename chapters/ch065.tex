...
\begin{itemize}
  \item Explain the central problem addressed by Containers and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Containers; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Containers define ownership, access patterns, complexity, and invalidation rules. Choosing one is a data-access decision, not merely a syntax decision.
...
The complete standalone program for this chapter is stored at examples/chapters/ch065.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch065.cpp}
