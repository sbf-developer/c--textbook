\chapter{Concepts and Constraints}
\index{Concepts and Constraints}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Concepts and Constraints and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Concepts and Constraints; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Concepts state requirements on template arguments in a readable form. Constraints improve overload selection and diagnostics, but they do not replace semantic documentation.
...
The complete standalone program for this chapter is stored at examples/chapters/ch084.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch084.cpp}
