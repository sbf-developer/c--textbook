...
\begin{itemize}
  \item Explain the central problem addressed by Benchmarking and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Benchmarking; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A benchmark is an experiment with a workload, harness, environment, and statistical summary. It measures that experiment, not every future use of the code.
...
The complete standalone program for this chapter is stored at examples/chapters/ch122.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch122.cpp}
