\chapter{Resource Ownership}
\index{Resource Ownership}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Resource Ownership and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Resource Ownership; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Files, locks, sockets, and memory all require a release protocol. Ownership answers who is responsible, when responsibility transfers, and how failure preserves the protocol.
...
The complete standalone program for this chapter is stored at examples/chapters/ch040.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch040.cpp}
