...
\begin{itemize}
  \item Explain the central problem addressed by Dependency Management and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Dependency Management; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Dependencies add capabilities and also add licensing, update, security, ABI, and reproducibility obligations. A dependency policy is part of system design.
...
The complete standalone program for this chapter is stored at examples/chapters/ch129.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch129.cpp}
