...
\begin{itemize}
  \item Explain the central problem addressed by Algorithms and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Algorithms; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Algorithms separate what should be done from how a container stores elements. Preconditions, projections, predicates, and complexity are part of an algorithm's contract.
...
The complete standalone program for this chapter is stored at examples/chapters/ch067.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch067.cpp}
