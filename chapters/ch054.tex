\chapter{Static Members}
\index{Static Members}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Static Members and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Static Members; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Static data and functions belong to the class rather than one object. They can represent shared policy or state, but global lifetime and synchronization costs should be explicit.
...
The complete standalone program for this chapter is stored at examples/chapters/ch054.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch054.cpp}
