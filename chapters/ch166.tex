\chapter{When C++ Is an Appropriate Tool}
\index{When C++ Is an Appropriate Tool}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by When C++ Is an Appropriate Tool and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: When C++ Is an Appropriate Tool; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
C++ is a strong choice when control over resource use, predictable performance, existing ecosystems, or native integration matters. Its costs include language complexity and a larger safety burden.
...
The complete standalone program for this chapter is stored at examples/chapters/ch166.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch166.cpp}
