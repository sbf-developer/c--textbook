\chapter{Large-Codebase Architecture}
\index{Large-Codebase Architecture}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Large-Codebase Architecture and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Large-Codebase Architecture; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Large systems need dependency direction, ownership of decisions, build boundaries, observability, and migration paths. Architecture is tested by how safely the system changes.
...
The complete standalone program for this chapter is stored at examples/chapters/ch181.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch181.cpp}
