\chapter{Installing a C++ Development Environment}
\index{Installing a C++ Development Environment}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Installing a C++ Development Environment and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Installing a C++ Development Environment; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A usable environment contains a compiler, standard library, debugger, editor, and build tools. Installation is treated as a reproducible configuration rather than a sequence of unexplained clicks.
...
The complete standalone program for this chapter is stored at examples/chapters/ch005.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch005.cpp}
