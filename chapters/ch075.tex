...
\begin{itemize}
  \item Explain the central problem addressed by Tuples and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Tuples; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Tuples group heterogeneous values without naming a domain type. They are useful for local composition but can become opaque at public API boundaries.
...
The complete standalone program for this chapter is stored at examples/chapters/ch075.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch075.cpp}
