...
\begin{itemize}
  \item Explain the central problem addressed by Member Functions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Member Functions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Member functions operate with an implicit object parameter. Their constness, ref-qualification, and exception behavior are part of the type's interface.
...
The complete standalone program for this chapter is stored at examples/chapters/ch052.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch052.cpp}
