\chapter{Inlining and Optimization}
\index{Inlining and Optimization}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Inlining and Optimization and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Inlining and Optimization; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Inlining is a compiler transformation, not a source-level command to make code fast. It can remove call overhead or expose optimization, but can also increase code size.
...
The complete standalone program for this chapter is stored at examples/chapters/ch160.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch160.cpp}
