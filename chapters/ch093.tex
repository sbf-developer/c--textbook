...
\begin{itemize}
  \item Explain the central problem addressed by Exceptions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Exceptions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Exceptions transfer control out of a failing operation. Good exception design names the boundary, preserves invariants, and avoids using exceptions as invisible ordinary control flow.
...
The complete standalone program for this chapter is stored at examples/chapters/ch093.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch093.cpp}
