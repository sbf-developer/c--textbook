...
\begin{itemize}
  \item Explain the central problem addressed by Coroutines and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Coroutines; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Coroutines suspend and resume a computation while a library-defined promise type controls the surrounding protocol. The language supplies machinery; scheduling, lifetime, and cancellation remain design responsibilities.
...
The complete standalone program for this chapter is stored at examples/chapters/ch172.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch172.cpp}
