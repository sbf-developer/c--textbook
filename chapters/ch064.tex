\chapter{The Purpose and Structure of the Standard Library}
\index{The Purpose and Structure of the Standard Library}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by The Purpose and Structure of the Standard Library and relate it to the C++ object, type, or program model.
  \item Use the idea in a small program, identify its main failure modes, and state one trade-off honestly.
\end{itemize}
\textbf{Prerequisites}: the preceding chapter, plus the vocabulary introduced in Part 5.

\textbf{Key terminology}: The Purpose and Structure of the Standard Library; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
The standard library supplies vocabulary types, containers, algorithms, utilities, and I/O. Learning its structure prevents unnecessary reinvention and makes code legible to other C++ programmers.
...
The complete standalone program for this chapter is stored at examples/chapters/ch064.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch064.cpp}
