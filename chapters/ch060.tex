...
\begin{itemize}
  \item Explain the central problem addressed by Virtual Functions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Virtual Functions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Virtual dispatch enables runtime polymorphism but introduces lifetime and destruction requirements. A polymorphic base normally needs a virtual destructor when deleted through the base interface.
...
The complete standalone program for this chapter is stored at examples/chapters/ch060.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch060.cpp}
