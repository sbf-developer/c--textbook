...
\begin{itemize}
  \item Explain the central problem addressed by Locks and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Locks; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Locks provide synchronization protocols, not automatic correctness. Lock ordering, scope, contention, and exception-safe release determine whether a design remains live.
...
The complete standalone program for this chapter is stored at examples/chapters/ch146.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch146.cpp}
