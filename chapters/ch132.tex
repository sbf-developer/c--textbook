...
\begin{itemize}
  \item Explain the central problem addressed by Documentation and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Documentation; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Documentation explains intent, contracts, constraints, and operations. It should answer questions that code alone cannot, without duplicating every implementation detail.
...
The complete standalone program for this chapter is stored at examples/chapters/ch132.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch132.cpp}
