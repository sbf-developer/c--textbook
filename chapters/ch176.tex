...
\begin{itemize}
  \item Explain the central problem addressed by Policy-Based Design and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Policy-Based Design; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Policy-based design parameterizes a type with independent behaviors. It can create precise reusable components, but too many policies can make the resulting type difficult to understand.
...
The complete standalone program for this chapter is stored at examples/chapters/ch176.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch176.cpp}
