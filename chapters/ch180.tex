\chapter{Stable Interfaces}
\index{Stable Interfaces}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Stable Interfaces and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Stable Interfaces; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A stable interface controls source, binary, behavioral, and operational compatibility. Compatibility is a budget with costs, not a property acquired by adding more abstraction.
...
The complete standalone program for this chapter is stored at examples/chapters/ch180.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch180.cpp}
