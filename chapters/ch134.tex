...
\begin{itemize}
  \item Explain the central problem addressed by Coding Conventions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Coding Conventions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Conventions reduce accidental variation and make review focus on behavior. They are most valuable when automated and kept subordinate to correctness.
...
The complete standalone program for this chapter is stored at examples/chapters/ch134.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch134.cpp}
