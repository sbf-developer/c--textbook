...
\begin{itemize}
  \item Explain the central problem addressed by Race Conditions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Race Conditions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A race exists when correctness depends on an uncontrolled ordering of operations. A program can appear correct for thousands of runs and still contain a race.
...
The complete standalone program for this chapter is stored at examples/chapters/ch144.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch144.cpp}
