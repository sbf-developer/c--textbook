\chapter{Scope, Lifetime, and Name Visibility}
\index{Scope, Lifetime, and Name Visibility}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Scope, Lifetime, and Name Visibility and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Scope, Lifetime, and Name Visibility; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Scope answers where a name can be used; lifetime answers when an object exists. They often align for local variables but are not the same concept.
...
The complete standalone program for this chapter is stored at examples/chapters/ch019.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch019.cpp}
