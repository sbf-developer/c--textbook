...
\begin{itemize}
  \item Explain the central problem addressed by Formatting and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Formatting; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Formatting turns values into human-readable or machine-readable text. Locale, escaping, alignment, and available library support all affect portability and correctness.
...
The complete standalone program for this chapter is stored at examples/chapters/ch079.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch079.cpp}
