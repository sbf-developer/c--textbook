...
\begin{itemize}
  \item Explain the central problem addressed by Structures and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Structures; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A struct groups related data and can provide behavior. In C++, struct and class differ primarily in default access, not in expressive power.
...
The complete standalone program for this chapter is stored at examples/chapters/ch046.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch046.cpp}
