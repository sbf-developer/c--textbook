...
\begin{itemize}
  \item Explain the central problem addressed by Defensive Programming and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Defensive Programming; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Defensive programming makes assumptions explicit at boundaries and preserves invariants. It should improve failure behavior without obscuring the actual contract.
...
The complete standalone program for this chapter is stored at examples/chapters/ch106.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch106.cpp}
