\chapter{Test Doubles}
\index{Test Doubles}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Test Doubles and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Test Doubles; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Stubs, fakes, spies, and mocks replace collaborators for a test. They are useful when a boundary is expensive or nondeterministic, but excessive mocking can test a design's seams rather than its behavior.
...
The complete standalone program for this chapter is stored at examples/chapters/ch100.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch100.cpp}
