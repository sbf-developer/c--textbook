...
\begin{itemize}
  \item Explain the central problem addressed by Invariants and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Invariants; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
An invariant is a condition that must hold at defined boundaries. Naming invariants turns informal assumptions into reviewable design and test obligations.
...
The complete standalone program for this chapter is stored at examples/chapters/ch051.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch051.cpp}
