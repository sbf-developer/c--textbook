\chapter{Function Parameters and Return Values}
\index{Function Parameters and Return Values}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Function Parameters and Return Values and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Function Parameters and Return Values; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Parameters and return values form a function's value-level interface. Passing by value, reference, pointer, or view communicates different ownership and lifetime expectations.
...
The complete standalone program for this chapter is stored at examples/chapters/ch021.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch021.cpp}
