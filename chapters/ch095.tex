\chapter{Expected-Style Error Handling}
\index{Expected-Style Error Handling}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Expected-Style Error Handling and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Expected-Style Error Handling; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
An expected-style result carries either a value or an error. It makes recoverable failure visible in the type and composes well when the caller can act locally.
...
The complete standalone program for this chapter is stored at examples/chapters/ch095.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch095.cpp}
