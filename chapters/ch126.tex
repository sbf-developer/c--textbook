...
\begin{itemize}
  \item Explain the central problem addressed by Libraries and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Libraries; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
A library packages reusable code as source, static binaries, or shared binaries. Consumers need a compatible interface, build configuration, and ABI story.
...
The complete standalone program for this chapter is stored at examples/chapters/ch126.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch126.cpp}
