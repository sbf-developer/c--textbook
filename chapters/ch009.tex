...
\begin{itemize}
  \item Explain the central problem addressed by Program Structure and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Program Structure; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
C++ programs are made from declarations, definitions, functions, namespaces, and statements. Structure determines what names mean and what the implementation is allowed to do.
...
The complete standalone program for this chapter is stored at examples/chapters/ch009.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch009.cpp}
