\chapter{Hardware, Software, and Operating Systems}
\index{Hardware, Software, and Operating Systems}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Hardware, Software, and Operating Systems and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Hardware, Software, and Operating Systems; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Programs run within layers. Processors execute instructions, memory stores state, devices expose effects, and operating systems mediate resources. The useful model is layered rather than a claim that every computer has one physical layout.
...
The complete standalone program for this chapter is stored at examples/chapters/ch002.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch002.cpp}
