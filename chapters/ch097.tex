...
\begin{itemize}
  \item Explain the central problem addressed by Unit Testing and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Unit Testing; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Unit tests isolate a small behavior and make its contract executable. A good test fails for a meaningful reason and remains independent of unrelated timing or global state.
...
The complete standalone program for this chapter is stored at examples/chapters/ch097.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch097.cpp}
