...
\begin{itemize}
  \item Explain the central problem addressed by Input and Output and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Input and Output; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Streams model formatted interaction with sources and sinks. The important engineering questions are parsing, failure states, buffering, and whether interactive input belongs in the domain logic.
...
The complete standalone program for this chapter is stored at examples/chapters/ch016.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch016.cpp}
