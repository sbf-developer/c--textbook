...
\begin{itemize}
  \item Explain the central problem addressed by Functions and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Functions; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Functions name reusable behavior and establish a boundary for inputs, outputs, side effects, and tests. Small functions are useful when their boundaries reflect meaningful responsibilities.
...
The complete standalone program for this chapter is stored at examples/chapters/ch020.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch020.cpp}
