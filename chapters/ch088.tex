...
\begin{itemize}
  \item Explain the central problem addressed by Type Traits and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Type Traits; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Type traits query or transform type properties. They are building blocks for generic constraints and adaptation, but a named concept is often clearer at an API boundary.
...
The complete standalone program for this chapter is stored at examples/chapters/ch088.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch088.cpp}
