...
\begin{itemize}
  \item Explain the central problem addressed by Graphs and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Graphs; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Graphs model entities and relationships. Choosing directedness, weights, and representation precedes selecting traversal or shortest-path algorithms.
...
The complete standalone program for this chapter is stored at examples/chapters/ch118.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch118.cpp}
