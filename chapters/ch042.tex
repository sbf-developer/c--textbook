...
\begin{itemize}
  \item Explain the central problem addressed by RAII and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: RAII; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Resource acquisition is initialization binds release to deterministic destruction. RAII makes early returns and exceptions ordinary control-flow paths rather than leaks to be remembered manually.
...
The complete standalone program for this chapter is stored at examples/chapters/ch042.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch042.cpp}
