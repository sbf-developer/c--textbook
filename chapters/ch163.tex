\chapter{Latency and Throughput}
\index{Latency and Throughput}
\begin{chaptermeta}
\textbf{Learning objectives}
\begin{itemize}
  \item Explain the central problem addressed by Latency and Throughput and relate it to the C++ object, type, or program model.
...
\textbf{Key terminology}: Latency and Throughput; contract; representation; lifetime; invariant; diagnostic; trade-off.
\end{chaptermeta}

\section{The problem and the mental model}
Latency measures the time for one operation; throughput measures completed work per unit time. A system can improve one while worsening the other.
...
The complete standalone program for this chapter is stored at examples/chapters/ch163.cpp and is compiled by the verification script.

\inputminted[fontsize=\scriptsize,breaklines]{cpp}{examples/chapters/ch163.cpp}
